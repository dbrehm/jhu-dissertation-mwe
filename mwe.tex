...
%
%\begin{refsection}[myrefs.bib]
\include{text/08-chapter-2-theory}
%\printbibliography[title={References}]
%\end{refsection}
%
%\begin{refsection}[myrefs.bib]
\include{text/09-chapter-3-cms-detector}
%\printbibliography[title={References}]
%\end{refsection}
%
%\begin{refsection}[myrefs.bib]
\include{text/14-chapter-4-tagging}
%\printbibliography[title={References}]
%\end{refsection}
%
%\begin{refsection}[myrefs.bib]
\include{text/10-chapter-5-hh4b}
%\printbibliography[title={References}]
%\end{refsection}
%
%\begin{refsection}[myrefs.bib]
\include{text/15-chapter-6-HH4b-Bkg}
  %\printbibliography[title={References}]
  %\end{refsection}
%\begin{refsection}[myrefs.bib]
\include{text/16-chapter-6-HH4b-results}
  %\printbibliography[title={References}]
  %\end{refsection}
%\begin{refsection}[myrefs.bib]
\include{text/12-chapter-6-extensions}
%\printbibliography[title={References}]
%\end{refsection}
%
%\begin{refsection}[myrefs.bib]
\include{text/11-chapter-7-discussion-conclusions}
%\printbibliography[title={References}]
%\end{refsection}
%
%%%%% BACK MATTER %%%%%
